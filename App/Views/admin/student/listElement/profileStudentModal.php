                                        ...
                                        <div class="col-lg-7 col-12">
                                            ...
                                            <form class="" action="">
                                                ...
                                                <div class="input-group d-flex justify-content-start col-lg-12 flex-nowrap">
                                                    ...
                                                    <input type="text" disabled class="form-control" value="<?=  $student->student_cpf?>" aria-label="Username" aria-describedby="addon-wrapping">
                                                </div>
                                                ...
                                                <div class="input-group d-flex justify-content-start col-lg-12 flex-nowrap">
                                                    ...
                                                    <input type="text" disabled class="form-control" value="<?=  $student->student_zipCode?>" aria-label="Username" aria-describedby="addon-wrapping">
                                                </div>
                                                ...
                                                <div class="input-group d-flex justify-content-start col-lg-12 flex-nowrap">
                                                    ...
                                                    <input type="text" disabled class="form-control" value="<?=  $student->telephone_number?>" aria-label="Username" aria-describedby="addon-wrapping">
                                                </div>
