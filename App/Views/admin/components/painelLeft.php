<div id="left-panel" class="row">
    ...
    <nav id="sidebar">
        ...
        <ul class="sidebar-lists">
            ...
            <li><a href="/admin/home"><i class="fas fa-layer-group"></i><span class="link-name">Home</span></a></li>

            <li><a href="/admin/gestao"><i class="fas fa-sliders-h"></i><span class="link-name">Gestão geral</span></a></li>
