...
class Discipline extends Model{
    ...
    public function updateDiscipline(){
        ...
        $query = 'update disciplina set nome_disciplina = :discipline , sigla = :acronym , fk_id_modalidade_disciplina = fk_id_modality where disciplina.id_disciplina = :idDiscipline;';
